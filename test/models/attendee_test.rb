...
class AttendeeTest < ActiveSupport::TestCase
  def setup 
    ...
    @user = User.create(created_at: "2014-07-15 03:19:57", updated_at: "2014-07-15 03:19:57", username: first_name + "." + last_name, first_name: first_name, last_name: last_name, admin: true, photo: nil, email: "matt.watson@orasi.com")
  end
